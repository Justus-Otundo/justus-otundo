...
export function Testimonials() {
  return (
    <>
      ...
      <section id="testimonials" className="py-20 relative" aria-label="Client testimonials">
                ...
                >
                  <Card className="p-6 h-full card-executive">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-accent-500 to-highlight-500 flex items-center justify-center" aria-hidden="true">
                    ...
                    <CardContent className="p-0">
                      <div className="text-highlight-500/40 mb-2" aria-hidden="true">
