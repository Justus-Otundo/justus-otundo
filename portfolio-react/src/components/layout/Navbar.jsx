...
export function Navbar() {
  ...
  return (
    ...
    >
      {/* Scroll progress bar */}
      <div
        className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-accent-500 to-highlight-500 origin-left z-50 transition-transform duration-150 ease-out"
